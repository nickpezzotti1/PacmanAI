...
def eval_fitness(genotype):
    res1 = int(os.popen('python pacman.py --pacman MDPAgent --layout smallGrid -q -a \"food_reward=%s,empty_reward=%s,min_dist=%s,gamma=%s\" -n 10'%(genotype[0], genotype[1], genotype[3], genotype[2])).read())
